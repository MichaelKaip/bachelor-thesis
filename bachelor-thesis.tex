...
\end{equation}
\\\\
\noindent Hat das zu untersuchende System also 3 zu berücksichtigende Faktoren, die jeweils in 2 Stufen $(+/-)$ variiert werden können, müssen bei einem vollständig faktoriellen Versuchsplan also $3^2 = 8$ Versuche durchgeführt werden. Der sich daraus ergebende Versuchsplan ist in folgender Tabelle \ref{tab:Versuchsplan} dargestellt.
