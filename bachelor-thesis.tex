...
Die Erzeugung von Bildern in unterschiedlichen Kalibrierungsstufen entspricht der im Abschnitt \ref{sec:ErzeugungVonBildern} auf Seite \pageref{sec:ErzeugungVonBildern} bereits eingehend beschriebenen Vorgehensweise und die nachstehende \textbf{Abbildung xyz} zeigt den funktionalen Ablauf entsprechend der umgesetzten Implementierung.

\begin{figure}[H]
	\centering
	\boxed{\includegraphics[scale=0.8]{pics/scaling_images}}
	\caption{Aktivitätsdiagramm zur Erstellung einer Bildserie mit AMGuss}
	\label{fig:Bilskalierung}
\end{figure}
...
\begin{equation}
	S_{fac} = \frac{\text{aktuelle Kalibrierung}}{Zielkalibrierung}
\end{equation}
mit
\begin{conditions}
	S_{fac} & Skalierungsfaktor
\end{conditions}
