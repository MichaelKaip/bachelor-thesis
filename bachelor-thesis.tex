...
\begin{figure}[H]
	\centering
	\boxed{\includegraphics[scale=0.299]{pics/ImgCalib10}}
...
\begin{figure}[H]
	\centering
	\boxed{\includegraphics[scale=0.5]{pics/ImgAddToSet}}
	\caption{Probenbild mit einer Kalibrierung von $1,0~\nicefrac{\mu m}{\text{Pixel}}$}
...
\begin{minipage}{1.0\linewidth}
	\begin{minipage}[t]{0.3\linewidth}\vspace{0pt}
		\begin{figure}[H]
			\boxed{\includegraphics[scale=0.55]{pics/ImgAddedToSet}}
			\caption{Probenbild mit einer Kalibrierung von $1,0~\nicefrac{\mu m}{\text{Pixel}}$}
			\label{fig:ImgPicBar}
		\end{figure}
	\end{minipage}
	\begin{minipage}[t]{0.69\linewidth}\vspace{0pt}
		\begin{figure}[H]
			\centering
			\boxed{\includegraphics[scale=0.4]{pics/ImgSetSave}}
			\caption{Probenbild mit einer Kalibrierung von $1,0~\nicefrac{\mu m}{\text{Pixel}}$}
...
\begin{figure}[H]
	\centering
	\boxed{\includegraphics[scale=0.35]{pics/ImgSetCalibration}}
...
\begin{figure}[H]
	\centering
	\boxed{\includegraphics[scale=0.45]{pics/CiaContent}}
...
\begin{figure}[H]
	\centering
	\boxed{\includegraphics[scale=0.6]{pics/LamelloResultWindowBlank}}
...
\begin{figure}[H]
	\centering
	\boxed{\includegraphics[scale=0.6]{pics/LamelloResultArea}}
...
\begin{figure}[H]
	\centering
	\boxed{\includegraphics[scale=0.6]{pics/LamelloResultArrangementClasses}}
...
\begin{figure}[H]
	\centering
	\boxed{\includegraphics[scale=0.8]{pics/LamelloReport}}
