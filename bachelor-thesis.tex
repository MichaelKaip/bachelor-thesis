...
\begin{figure}[H]
	...
	\draw  [color={rgb, 255:red, 74; green, 74; blue, 74 }  ,draw opacity=1 ][line width=1.5]  (38,65) -- (500,65) -- (500,455) -- (38,455) -- cycle ;
	%Shape: Rectangle [id:dp13785643688738514] 
	\draw  [color={rgb, 255:red, 126; green, 211; blue, 33 }  ,draw opacity=1 ][fill={rgb, 255:red, 155; green, 155; blue, 155 }  ,fill opacity=1 ][line width=2.25]  (192,237) -- (358,237) -- (358,272) -- (192,272) -- cycle ;
	
	% Text Node
	\draw (208,246) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\Large \textbf{\textcolor[rgb]{0.49,0.83,0.13}{Versuchspläne}}}};
	% Text Node
	\draw (67,92) node [anchor=north west][inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{142.35pt}\setlength\topsep{0pt}
			\begin{center}
				\textbf{\textcolor[rgb]{0.29,0.29,0.29}{vollständig faktorieller }}\\\textbf{\textcolor[rgb]{0.29,0.29,0.29}{Versuchsplan}}\\{\footnotesize \textcolor[rgb]{0.29,0.29,0.29}{Dabei werden die Einflussfaktoren }}\\{\footnotesize \textcolor[rgb]{0.29,0.29,0.29}{in ihren Stufen vollständig kombiniert und gleichzeitig variiert.}}
			\end{center}
			
	\end{minipage}};
	% Text Node
	\draw (291,337) node [anchor=north west][inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{142.63pt}\setlength\topsep{0pt}
			\begin{center}
				\textbf{\textcolor[rgb]{0.29,0.29,0.29}{teilfaktorieller Versuchsplan}}\\{\footnotesize \textcolor[rgb]{0.29,0.29,0.29}{Ist bei der Aufgabenstellung nicht die }}\\{\footnotesize \textcolor[rgb]{0.29,0.29,0.29}{vollständige Wechselwirkung der }}\\{\footnotesize \textcolor[rgb]{0.29,0.29,0.29}{Einflussgrößen auf die Zielgröße }}\\{\footnotesize \textcolor[rgb]{0.29,0.29,0.29}{von Interesse, lässt sich der }}\\{\footnotesize \textcolor[rgb]{0.29,0.29,0.29}{Versuchsplan reduzieren.}}
			\end{center}
			
	\end{minipage}};
	% Text Node
	\draw (286,107) node [anchor=north west][inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{135.17pt}\setlength\topsep{0pt}
			\begin{center}
				\textbf{\textcolor[rgb]{0.29,0.29,0.29}{faktorieller Versuchsplan }}\\\textbf{\textcolor[rgb]{0.29,0.29,0.29}{mit Zentralpunkt}}\\{\footnotesize \textcolor[rgb]{0.29,0.29,0.29}{Wird verwendet, um zu überprüfen }}\\{\footnotesize \textcolor[rgb]{0.29,0.29,0.29}{ob Nichtlinearitäten vorliegen.}}
			\end{center}
			
	\end{minipage}};
	% Text Node
	\draw (52,335) node [anchor=north west][inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{148.78pt}\setlength\topsep{0pt}
			\begin{center}
				\textbf{\textcolor[rgb]{0.29,0.29,0.29}{lateinische Quadrate}}\\{\footnotesize \textcolor[rgb]{0.29,0.29,0.29}{Nur dann sinnvoll, wenn gesichert ist, }}\\{\footnotesize \textcolor[rgb]{0.29,0.29,0.29}{dass Wechselwirkungen zwischen den }}\\{\footnotesize \textcolor[rgb]{0.29,0.29,0.29}{Einflussgrößen keine Rolle spielen oder }}\\{\footnotesize \textcolor[rgb]{0.29,0.29,0.29}{vernachlässigt \ werden können.}}
			\end{center}
			
	\end{minipage}};
	% Connection
	\draw [color={rgb, 255:red, 126; green, 211; blue, 33 }  ,draw opacity=1 ][line width=3]    (260.2,271) -- (211.89,326.47) ;
	\draw [shift={(207.95,331)}, rotate = 311.05] [fill={rgb, 255:red, 126; green, 211; blue, 33 }  ,fill opacity=1 ][line width=0.08]  [draw opacity=0] (16.97,-8.15) -- (0,0) -- (16.97,8.15) -- cycle    ;
	% Connection
	\draw [color={rgb, 255:red, 126; green, 211; blue, 33 }  ,draw opacity=1 ][line width=3]    (288.99,271) -- (336.2,328.37) ;
	\draw [shift={(340.01,333)}, rotate = 230.55] [fill={rgb, 255:red, 126; green, 211; blue, 33 }  ,fill opacity=1 ][line width=0.08]  [draw opacity=0] (16.97,-8.15) -- (0,0) -- (16.97,8.15) -- cycle    ;
	% Connection
	\draw [color={rgb, 255:red, 126; green, 211; blue, 33 }  ,draw opacity=1 ][line width=3]    (261.1,237) -- (215.85,181.65) ;
	\draw [shift={(212.05,177)}, rotate = 410.73] [fill={rgb, 255:red, 126; green, 211; blue, 33 }  ,fill opacity=1 ][line width=0.08]  [draw opacity=0] (16.97,-8.15) -- (0,0) -- (16.97,8.15) -- cycle    ;
	% Connection
	\draw [color={rgb, 255:red, 126; green, 211; blue, 33 }  ,draw opacity=1 ][line width=3]    (289.82,237) -- (338.19,181.52) ;
	\draw [shift={(342.14,177)}, rotate = 491.09] [fill={rgb, 255:red, 126; green, 211; blue, 33 }  ,fill opacity=1 ][line width=0.08]  [draw opacity=0] (16.97,-8.15) -- (0,0) -- (16.97,8.15) -- cycle    ;
	\end{tikzpicture}
...
\end{equation}
\\\\
\noindent Hat das zu untersuchende System also 3 zu berücksichtigende Faktoren, die jeweils in 2 Stufen $(+/-)$ variiert werden können, müssen bei einem vollständig faktoriellen Versuchsplan also $3^2 = 8$ Versuche durchgeführt werden. Der sich daraus ergebende Versuchsplan ist in folgender Tabelle xyz dargestellt.
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1, scale=0.7, every node/.style={scale=0.7}]
		...
		%Straight Lines [id:da009429095814716959] 
		\draw    (201,413) -- (201,426) ;
		%Straight Lines [id:da6408604526403883] 
		\draw    (304,414) -- (304,427) ;
		%Straight Lines [id:da5720641419192563] 
		\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ]   (230,414) -- (230,427) ;
		%Straight Lines [id:da3865033621633087] 
		\draw    (183,414) -- (183,427) ;
		%Straight Lines [id:da7586148570180449] 
		\draw    (261,414) -- (261,427) ;
		%Straight Lines [id:da6213998766294877] 
		\draw    (412,414) -- (412,427) ;
		%Straight Lines [id:da21868777946411622] 
		\draw    (172,414) -- (172,427) ;
		...
		% Text Node
		\draw (159,430) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize] [align=left] {0,15};
		% Text Node
		\draw (172,443) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize] [align=left] {0,20};
		% Text Node
		\draw (186,430) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize] [align=left] {0,30};
		% Text Node
		\draw (218,430) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize,color={rgb, 255:red, 208; green, 2; blue, 27 }  ,opacity=1 ] [align=left] {(0,50)};
		% Text Node
		\draw (250,442) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize] [align=left] {0,70};
		% Text Node
		\draw (292,430) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize] [align=left] {1,10};
		% Text Node
		\draw (401,430) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize] [align=left] {1,90};
		% Text Node
		\draw (197,397) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize,color={rgb, 255:red, 208; green, 2; blue, 27 }  ,opacity=1 ] [align=left] {(Zielkalibrierung)};
		% Text Node
		...
		% Text Node
		\draw (192,463) node [anchor=north west][inner sep=0.75pt]  [font=\normalsize] [align=left] {\textbf{Ausgangskalibrierungen}};
		% Text Node
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1, scale=1.0, every node/.style={scale=1.0}]
		...
		%Rounded Rect [id:dp3049260414034314] 
		\draw  [color={rgb, 255:red, 155; green, 155; blue, 155 }  ,draw opacity=1 ][fill={rgb, 255:red, 155; green, 155; blue, 155 }  ,fill opacity=0.12 ] (420,88) .. controls (420,83.58) and (423.58,80) .. (428,80) -- (504,80) .. controls (508.42,80) and (512,83.58) .. (512,88) -- (512,112) .. controls (512,116.42) and (508.42,120) .. (504,120) -- (428,120) .. controls (423.58,120) and (420,116.42) .. (420,112) -- cycle ;
		%Rounded Rect [id:dp829472062905211] 
		\draw  [color={rgb, 255:red, 155; green, 155; blue, 155 }  ,draw opacity=1 ][fill={rgb, 255:red, 155; green, 155; blue, 155 }  ,fill opacity=0.12 ] (420,149) .. controls (420,144.58) and (423.58,141) .. (428,141) -- (504,141) .. controls (508.42,141) and (512,144.58) .. (512,149) -- (512,173) .. controls (512,177.42) and (508.42,181) .. (504,181) -- (428,181) .. controls (423.58,181) and (420,177.42) .. (420,173) -- cycle ;
		%Rounded Rect [id:dp5049349195701525] 
		\draw  [color={rgb, 255:red, 155; green, 155; blue, 155 }  ,draw opacity=1 ][fill={rgb, 255:red, 155; green, 155; blue, 155 }  ,fill opacity=0.12 ] (420,388) .. controls (420,383.58) and (423.58,380) .. (428,380) -- (504,380) .. controls (508.42,380) and (512,383.58) .. (512,388) -- (512,412) .. controls (512,416.42) and (508.42,420) .. (504,420) -- (428,420) .. controls (423.58,420) and (420,416.42) .. (420,412) -- cycle ;
		%Rounded Rect [id:dp7024977089857076] 
		\draw  [color={rgb, 255:red, 155; green, 155; blue, 155 }  ,draw opacity=1 ][fill={rgb, 255:red, 155; green, 155; blue, 155 }  ,fill opacity=0.12 ] (420,207) .. controls (420,202.58) and (423.58,199) .. (428,199) -- (504,199) .. controls (508.42,199) and (512,202.58) .. (512,207) -- (512,231) .. controls (512,235.42) and (508.42,239) .. (504,239) -- (428,239) .. controls (423.58,239) and (420,235.42) .. (420,231) -- cycle ;
		%Rounded Rect [id:dp7889794089989934] 
		\draw  [color={rgb, 255:red, 155; green, 155; blue, 155 }  ,draw opacity=1 ][fill={rgb, 255:red, 155; green, 155; blue, 155 }  ,fill opacity=0.12 ] (420,266) .. controls (420,261.58) and (423.58,258) .. (428,258) -- (504,258) .. controls (508.42,258) and (512,261.58) .. (512,266) -- (512,290) .. controls (512,294.42) and (508.42,298) .. (504,298) -- (428,298) .. controls (423.58,298) and (420,294.42) .. (420,290) -- cycle ;
		%Rounded Rect [id:dp17780665664929307] 
		\draw  [color={rgb, 255:red, 155; green, 155; blue, 155 }  ,draw opacity=1 ][fill={rgb, 255:red, 155; green, 155; blue, 155 }  ,fill opacity=0.12 ] (420,328) .. controls (420,323.58) and (423.58,320) .. (428,320) -- (504,320) .. controls (508.42,320) and (512,323.58) .. (512,328) -- (512,352) .. controls (512,356.42) and (508.42,360) .. (504,360) -- (428,360) .. controls (423.58,360) and (420,356.42) .. (420,352) -- cycle ;
		%Rounded Rect [id:dp08184078829998631] 
		\draw  [color={rgb, 255:red, 155; green, 155; blue, 155 }  ,draw opacity=1 ][fill={rgb, 255:red, 126; green, 211; blue, 33 }  ,fill opacity=1 ] (300,188) .. controls (300,183.58) and (303.58,180) .. (308,180) -- (373,180) .. controls (377.42,180) and (381,183.58) .. (381,188) -- (381,212) .. controls (381,216.42) and (377.42,220) .. (373,220) -- (308,220) .. controls (303.58,220) and (300,216.42) .. (300,212) -- cycle ;
		...
		\draw [color={rgb, 255:red, 126; green, 211; blue, 33 }  ,draw opacity=1 ][line width=1.5]    (260,420) -- (300,280) ;
		...
		%Straight Lines [id:da678033786205831] 
		\draw [color={rgb, 255:red, 126; green, 211; blue, 33 }  ,draw opacity=1 ][line width=1.5]    (380,200) -- (420,100) ;
		%Straight Lines [id:da10268204898510325] 
		\draw [color={rgb, 255:red, 126; green, 211; blue, 33 }  ,draw opacity=1 ][line width=1.5]    (380,200) -- (420,160) ;
		%Straight Lines [id:da034281361725659654] 
		\draw [color={rgb, 255:red, 126; green, 211; blue, 33 }  ,draw opacity=1 ][line width=1.5]    (380,200) -- (420,220) ;
		%Straight Lines [id:da2643278430637781] 
		\draw [color={rgb, 255:red, 126; green, 211; blue, 33 }  ,draw opacity=1 ][line width=1.5]    (380,200) -- (420,280) ;
		%Straight Lines [id:da4741075133489321] 
		\draw [color={rgb, 255:red, 126; green, 211; blue, 33 }  ,draw opacity=1 ][line width=1.5]    (380,200) -- (420,340) ;
		%Straight Lines [id:da8533320850791501] 
		\draw [color={rgb, 255:red, 126; green, 211; blue, 33 }  ,draw opacity=1 ][line width=1.5]    (380,200) -- (420,400) ;
		%Straight Lines [id:da25537012675579795] 
		\draw [color={rgb, 255:red, 126; green, 211; blue, 33 }  ,draw opacity=1 ][line width=1.5]    (380,280) -- (420,100) ;
		%Straight Lines [id:da11787503920002229] 
		\draw [color={rgb, 255:red, 126; green, 211; blue, 33 }  ,draw opacity=1 ][line width=1.5]    (380,280) -- (420,160) ;
		%Straight Lines [id:da6232291480480245] 
		\draw [color={rgb, 255:red, 126; green, 211; blue, 33 }  ,draw opacity=1 ][line width=1.5]    (380,280) -- (420,220) ;
		%Straight Lines [id:da13449975611434883] 
		\draw [color={rgb, 255:red, 126; green, 211; blue, 33 }  ,draw opacity=1 ][line width=1.5]    (380,280) -- (420,280) ;
		%Straight Lines [id:da6379073358336698] 
		\draw [color={rgb, 255:red, 126; green, 211; blue, 33 }  ,draw opacity=1 ][line width=1.5]    (380,280) -- (420,340) ;
		%Straight Lines [id:da8648604964482902] 
		\draw [color={rgb, 255:red, 126; green, 211; blue, 33 }  ,draw opacity=1 ][line width=1.5]    (380,280) -- (420,400) ;
		...
		\draw [color={rgb, 255:red, 155; green, 155; blue, 155 }  ,draw opacity=1 ][line width=1.5]    (520,100) -- (577.6,176.8) ;
		\draw [shift={(580,180)}, rotate = 233.13] [fill={rgb, 255:red, 155; green, 155; blue, 155 }  ,fill opacity=1 ][line width=0.08]  [draw opacity=0] (11.61,-5.58) -- (0,0) -- (11.61,5.58) -- cycle    ;
		%Straight Lines [id:da4083043177775638] 
		\draw [color={rgb, 255:red, 155; green, 155; blue, 155 }  ,draw opacity=1 ][line width=1.5]    (520,160) -- (537.17,177.17) ;
		\draw [shift={(540,180)}, rotate = 225] [fill={rgb, 255:red, 155; green, 155; blue, 155 }  ,fill opacity=1 ][line width=0.08]  [draw opacity=0] (11.61,-5.58) -- (0,0) -- (11.61,5.58) -- cycle    ;
		%Straight Lines [id:da46948645691108726] 
		\draw [color={rgb, 255:red, 155; green, 155; blue, 155 }  ,draw opacity=1 ][line width=1.5]    (520,220) -- (537.17,237.17) ;
		\draw [shift={(540,240)}, rotate = 225] [fill={rgb, 255:red, 155; green, 155; blue, 155 }  ,fill opacity=1 ][line width=0.08]  [draw opacity=0] (11.61,-5.58) -- (0,0) -- (11.61,5.58) -- cycle    ;
		%Straight Lines [id:da6497409957223708] 
		\draw [color={rgb, 255:red, 155; green, 155; blue, 155 }  ,draw opacity=1 ][line width=1.5]    (520,280) -- (537.17,262.83) ;
		\draw [shift={(540,260)}, rotate = 495] [fill={rgb, 255:red, 155; green, 155; blue, 155 }  ,fill opacity=1 ][line width=0.08]  [draw opacity=0] (11.61,-5.58) -- (0,0) -- (11.61,5.58) -- cycle    ;
		%Straight Lines [id:da6279553174742234] 
		\draw [color={rgb, 255:red, 155; green, 155; blue, 155 }  ,draw opacity=1 ][line width=1.5]    (520,340) -- (537.17,322.83) ;
		\draw [shift={(540,320)}, rotate = 495] [fill={rgb, 255:red, 155; green, 155; blue, 155 }  ,fill opacity=1 ][line width=0.08]  [draw opacity=0] (11.61,-5.58) -- (0,0) -- (11.61,5.58) -- cycle    ;
		%Straight Lines [id:da9804292425008414] 
		\draw [color={rgb, 255:red, 155; green, 155; blue, 155 }  ,draw opacity=1 ][line width=1.5]    (520,400) -- (577.6,323.2) ;
		\draw [shift={(580,320)}, rotate = 486.87] [fill={rgb, 255:red, 155; green, 155; blue, 155 }  ,fill opacity=1 ][line width=0.08]  [draw opacity=0] (11.61,-5.58) -- (0,0) -- (11.61,5.58) -- cycle    ;
		
		% Text Node
		\draw (170,55) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize] [align=left] {Nearest Neighbor};
		% Text Node
		\draw (172,106) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize] [align=left] {\begin{minipage}[lt]{56.71pt}\setlength\topsep{0pt}
				\begin{center}
		...
		\end{minipage}};
		% Text Node
		\draw (197,177) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\scriptsize Linear}};
		% Text Node
		\draw (183,235) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\scriptsize Linear Exact}};
		% Text Node
		\draw (196,296) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\scriptsize Cubic}};
		% Text Node
		\draw (198,355) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\scriptsize Area}};
		% Text Node
		\draw (190,415) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\scriptsize Lanczos}};
		% Text Node
		\draw (304,196) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\scriptsize \textbf{Vollskalierung}}};
		% Text Node
		\draw (309,260) node [anchor=north west][inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{44pt}\setlength\topsep{0pt}
				\begin{center}
		...
		\end{minipage}};
		% Text Node
		\draw (435,97) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize] [align=left] {$\displaystyle 0,15\ \nicefrac{\mu m}{\text{Pixel}}$};
		% Text Node
		\draw (435,158) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize] [align=left] {$\displaystyle 0,20\ \nicefrac{\mu m}{\text{Pixel}}$};
		% Text Node
		\draw (435,215) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize] [align=left] {$\displaystyle 0,30\ \nicefrac{\mu m}{\text{Pixel}}$};
		% Text Node
		\draw (435,274) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize] [align=left] {$\displaystyle 0,70\ \nicefrac{\mu m}{\text{Pixel}}$};
		% Text Node
		\draw (434,336) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize] [align=left] {$\displaystyle 1,10\ \nicefrac{\mu m}{\text{Pixel}}$};
		% Text Node
		\draw (434,396) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize] [align=left] {$\displaystyle 1,90\ \nicefrac{\mu m}{\text{Pixel}}$};
		% Text Node
		\draw (589.07,248.37) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 255; green, 255; blue, 255 }  ,opacity=1 ] [align=left] {\begin{minipage}[lt]{33.93pt}\setlength\topsep{0pt}
				\begin{center}
					19.488\\Bilder
				\end{center}
		...
		\end{minipage}};
		% Text Node
		\draw (27.32,248.37) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 255; green, 255; blue, 255 }  ,opacity=1 ] [align=left] {\begin{minipage}[lt]{28.8pt}\setlength\topsep{0pt}
				\begin{center}
					232\\Bilder
				\end{center}
