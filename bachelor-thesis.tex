...
\begin{figure}[H]
	\centering
	\boxed{\includegraphics[scale=0.8]{pics/components}}
...
\begin{figure}[H]
	\centering
	\boxed{\includegraphics[scale=0.6]{pics/flow_scaling_images}}
...
\begin{figure}[H]
	\centering
	\boxed{\includegraphics[scale=0.7]{pics/flow_create_picture_set_amguss}}
	\caption{Aktivitätsdiagramm zur Erstellung einer Bildserie mit AMGuss}
...
\begin{figure}[H]
	\centering
	\boxed{\includegraphics[scale=0.6]{pics/flow_lamellar_graphite_evaluation}}
...
\begin{figure}[H]
	\centering
	\boxed{\includegraphics[scale=0.6]{pics/classify_data}}
...
\begin{figure}[H]
	\centering
	\boxed{\includegraphics[scale=0.6]{pics/flow_parsing_data}}
...
\begin{figure}[H]
	\centering
	\boxed{\includegraphics[scale=0.6]{pics/flow_doe}}
...
\begin{figure}[H]
	\centering
	\boxed{\includegraphics[scale=0.6]{pics/flow_data_to_excel}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=11cm, height=\textheight, keepaspectratio]{pics/DA_Gesamt_Streu1_AKL}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=11cm, height=\textheight, keepaspectratio]{pics/DA_Gesamt_Streu2_AKL}
...
Bei der Einzelwertbetrachtung (Abbildung \ref{fig:DAEinzelAbsolutAKL}) fällt auf, das die Fehlerwerte in den Anordnungsklassen A und C jeweils rapide ansteigen und danach in etwa gleich steil wieder sinken, wohingegen zwischen Klasse D und E nur ein vergleichsweise geringer Anstieg zu erkennen ist.
...
\colorbox{gray!10}{
	...
	\begin{minipage}{0.975\textwidth}
		...
		\\\\
		Der zuvor festgestellte Zusammenhang, dass die Verkleinerung von Bildern offensichtlich geringere Fehler erzeugt, als die Vergrößerung, lässt sich hier nicht eindeutig bestätigen.
	\end{minipage}
}
...
\noindent Anhand der Abbildung ist zu erkennen, dass die Fehler in einem Kalibrierungsbereich von 0,3 - 0,5 $\nicefrac{\mu m}{\text{Pixel}}$ zunächst stark abnehmen un dann wieder stark ansteigen. Die eingezeichneten Benchmark-Linien ergeben sich aus den Mittelwerten in der entsprechenden Größenklassenkategorie und es wird vermutet, dass alle Werte, die unterhalb dieser Linie liegen, die in Abschnitt \ref{sec:DefAnforderungenAnordnKlas} auf Seite \pageref{sec:DefAnforderungenAnordnKlas} beschrieben wurden, zu erfüllen. Allerdings ist die Beantwortung der Frage, was den genau ein tolerierbarer Fehlerwert ist, nicht Teil dieser Arbeit. 
\\\\
\noindent Abgesehen davon kann jedoch als Ergebnis in dieser Arbeit festgestellt werden, dass die Anwendung eines Standard-Klassifikators nur empfehlenswert bei Bildern mit hoher Auflösung ist, also $< 1,0 \nicefrac{\mu m}{Pixel}$. Das bei heutigen modernen Kameras mit hoher Auflösung immer gegeben, wobei die Kalibrierung bei Bildern die mit älteren Kameramodellen (z.B. PAL-D mit einem Standard-Signal von 768 $\times$ 576 Pixeln) aufgenommen wurden eher bei > 1,0 $\nicefrac{\mu m}{\text{Pixel}}$ liegt.
